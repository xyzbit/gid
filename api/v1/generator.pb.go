...
func (x *NextIDReq) GetModule() string {
	if x != nil {
		return x.Module
	}
	return ""
...
func (x *NextIDReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NextIDReply) ProtoMessage() {}

func (x *NextIDReply) ProtoReflect() protoreflect.Message {
	mi := &file_generator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NextIDReply.ProtoReflect.Descriptor instead.
func (*NextIDReply) Descriptor() ([]byte, []int) {
	return file_generator_proto_rawDescGZIP(), []int{1}
}

func (x *NextIDReply) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_generator_proto_rawDesc = []byte{
	...
	,
...
var file_generator_proto_goTypes = []interface{}{
	(*NextIDReq)(nil),   // 0: gid.api.v1.NextIDReq
	(*NextIDReply)(nil), // 1: gid.api.v1.NextIDReply
}
var file_generator_proto_depIdxs = []int32{
	0, // 0: gid.api.v1.Generator.NextID:input_type -> gid.api.v1.NextIDReq
	1, // 1: gid.api.v1.Generator.NextID:output_type -> gid.api.v1.NextIDReply
